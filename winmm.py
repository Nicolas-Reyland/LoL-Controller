...
def get_joystick_info():
	...
	# Build a list of currently pressed buttons.
	pressed_buttons = [btn for btn in button_names + povbtn_names if button_states.get(btn)]

	return (x, y), (rx, ry), (lt, rt), pressed_buttons
